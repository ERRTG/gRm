...
#' @export
model_graph.gRm_gllrm_spec <- model_graph.gRm_model
...
#' @export
model_graph.gRm_gllrm_fit <- model_graph.gRm_fit
...
#' @export
plot.gRm_gllrm_spec <- plot.gRm_model
...
#' @export
plot.gRm_gllrm_fit <- plot.gRm_fit
